CREATE TABLE IF NOT EXISTS imap_connector_configs (
...
CREATE INDEX IF NOT EXISTS imap_connector_configs_scope_idx
  ON imap_connector_configs (tenant_id, host, mailbox);
