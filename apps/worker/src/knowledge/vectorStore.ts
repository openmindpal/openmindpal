...
import type { VectorStoreCapabilitiesV1, VectorStoreChunkEmbeddingV1, VectorStoreQueryResponseV1, VectorStoreRefV1 } from "@openslin/shared";
...
export type VectorStore = {
  ...
  upsertEmbeddings(params: { pool: Pool; embeddings: VectorStoreChunkEmbeddingV1[] }): Promise<{ ok: true } | { ok: false; degraded: boolean; reason: string }>;
...
class ExternalVectorStore implements VectorStore {
  ...
  async upsertEmbeddings(params: { pool: Pool; embeddings: VectorStoreChunkEmbeddingV1[] }) {
